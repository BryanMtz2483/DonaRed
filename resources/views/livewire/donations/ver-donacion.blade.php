<div>
    <!-- Modal backdrop -->
    <div class="fixed inset-0 bg-black/50 z-40 backdrop-blur-sm top-16" wire:click="closeModal()"></div>
    
    <!-- Modal -->
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 top-16 overflow-y-auto">
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full my-8" wire:click.stop>
            
            <!-- Header with close button -->
            <div class="sticky top-0 bg-gradient-to-r from-red-500/90 via-yellow-400/80 to-green-500/90 px-4 sm:px-6 py-4 flex justify-between items-center rounded-t-2xl">
            ...
            <!-- Content -->
            <div class="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 bg-gradient-to-b from-white via-orange-50 to-yellow-50 max-h-[calc(100vh-150px)] overflow-y-auto">
                
                <!-- Donante Info -->
                <div class="card-glass p-3 sm:p-4">
                    <p class="text-xs sm:text-sm text-zinc-600 mb-1">👤 Donante</p>
                ...
                <div class="grid grid-cols-2 gap-2 sm:gap-4">
                    ...
                    <div class="card-glass p-3 sm:p-4">
                        <p class="text-xs text-zinc-600 mb-1">📅 Publicado</p>
                        <p class="text-sm sm:text-base font-semibold text-zinc-900">
                    ...
                    <div class="card-glass p-3 sm:p-4">
                        <p class="text-xs text-zinc-600 mb-1">👁️ Solicitudes</p>
                        <p class="text-sm sm:text-base font-semibold text-zinc-900">
                    ...
                    <div class="card-glass p-3 sm:p-4">
                        <p class="text-xs text-zinc-600 mb-1">📊 Estado</p>
